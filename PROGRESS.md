...
**작업 브랜치**: `refactor/csv-to-json` — main 미병합·미배포. 신규 커밋 4개 누적.
...
- [ ] **배포** — main 병합 + push → GitHub Pages 자동 반영. *사용자 결정 대기*
- [ ] 여담론 고아 문법 1건 복구 (선택 — `充足` 텍스트에 맞춰 인덱스 보정 필요)
- [ ] 양성편 s7·s8·s21 드릴다운 0건 (데이터 완성도, 필수 아님)
